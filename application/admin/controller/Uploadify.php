...
class Uploadify extends Common{
    ...
    public function fileList()
    {
    	...
    	$path = '/uploads/'.upload_pathedit(input('path','temp'));
    	...
    	$end = $start + $size;
    	//echo $path;echo '--';echo $allowFiles;echo '--';echo $key;exit;
    	/* 获取文件列表 */
    	$handle = opendir($path);
    	//echo $handle;exit;
    ...
    private function getfiles($path, $allowFiles, $key, &$files = array()){
        $path = "http://www.sxkj.com/uploads/artist/B11/pirture/";
