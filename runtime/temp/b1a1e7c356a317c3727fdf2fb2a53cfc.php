<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"C:\phpStudy\PHPTutorial\WWW\price_adjust\public/../application/admin\view\uploadify\upload.htm";i:1531109324;}*/ ?>
<html lang="zh-cn">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
<title>文件管理</title>
<link rel="stylesheet" type="text/css" href="__ADMIN__/style/webuploader/webuploader.css">
<link rel="stylesheet" type="text/css" href="__ADMIN__/style/webuploader/css/style.css">
</head>
<body>
...
<script type="text/javascript" src="__ADMIN__/style/webuploader/webuploader.min.js"></script>
<script type="text/javascript" src="__ADMIN__/style/webuploader/upload.js"></script>
<script>
$(function(){
	moudle = 'Admin';
	var config = {
