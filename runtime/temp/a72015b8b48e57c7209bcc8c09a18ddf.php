<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"C:\phpStudy\PHPTutorial\WWW\price_adjust\public/../application/admin\view\notice\edit.htm";i:1532338181;s:88:"C:\phpStudy\PHPTutorial\WWW\price_adjust\public/../application/admin\view\public\top.htm";i:1531707249;s:89:"C:\phpStudy\PHPTutorial\WWW\price_adjust\public/../application/admin\view\public\left.htm";i:1531214619;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
        	<div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改通知信息</span>
                       ...
                       <div class="tab-content tabs-flat">
                           <div id="home11" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<span class="input-icon icon-right">
                                           <input class="form-control date-picker" readonly="readonly" id ="publish_time"  type="text" value="<?php echo date("Y-m-d",$notice['s_time']); ?> ~ <?php echo date("Y-m-d",$notice['e_time']); ?>">
                                           <input class="form-control date-picker" readonly="readonly" id ="publish_stime" name="s_time" type="hidden" data-date-format="dd-mm-yyyy" value="<?php echo date("Y-m-d",$notice['s_time']); ?>">
                                           <input class="form-control date-picker" readonly="readonly" id ="publish_etime" name="e_time" type="hidden" data-date-format="dd-mm-yyyy" value="<?php echo date("Y-m-d",$notice['e_time']); ?>">
								...
								<div class="form-group">
		                            ...
		                            <label for="username" class="col-sm-2 control-label no-padding-right">相关型号</label>
		                            <div class="col-lg-5 col-sm-6 col-xs-12">
                                        <div>
                                            ...
                                            style="display:none;" name="type" id="form-field-tags" value="<?php echo $notice['type']; ?>">
                                            <input  type="text" style="height:40px;" class="tags_enter" autocomplete="off">
                                            </div>
                                        </div>
                        			</div>
                        		</div>
<input type="text" style="display:none;" name="typeid" id="form-field-typeid" value="<?php echo $notice['typeid']; ?>">
...
<!-- <!-- 上传图片 -->
                        		<div class="form-group">
		                            <label for="username" class="col-sm-2 control-label no-padding-right">示例图片</label>
			                            <div class="col-sm-4">
			                                <input type="button" value="上传图片"  class="btn btn-palegreen shiny"
			                                 onclick="GetUploadify(1,'original_img','notice','call_back_img');"/>
                                        	<input type="hidden" class="input-sm original_img"  name="imgurl" 
                                        	id="original_img" value="<?php echo $notice['imgurl']; ?>" onchange="changesrc(this.value)" />
										<?php if($notice['imgurl'] != null): ?>
	             							<a target='_blank' href='<?php echo $notice['imgurl']; ?>' id='original_img2'>
	                                        <img width='25'  class='img_thb' height='25' src='<?php echo $notice['imgurl']; ?>'
...
<!-- <!-- 上传图片 -->
	                                    ...
	                                    <div class="col-sm-6">
	                                       <div class="checkbox">
	                                        	<label>
	                                                ...
	                                                type="checkbox" name="zhuangtai" value="1" <?php if($notice['zhuangtai'] == 1): ?>checked="checked"<?php endif; ?>>
                                ...
                                <div class="form-group">
		                            ...
		                            <div class="col-sm-3">
		                                <textarea rows="5" name="desc" class="form-control" id="desc" style="width:420px;"><?php echo $notice['desc']; ?></textarea>
...
function spite_key(){
	...
	var tags_typeid = $("#form-field-typeid").val();
	
	if(tags&&tags_typeid){
		var tagss=tags.split(",");
		var tagss_typeid=tags_typeid.split(",");
		
		//构建数组
		var tagaa_array = new Array();
		   /* $.each(tagss, function( k, v ) {
			   tagaa_array[k] = v;
			} );  */
	  	 for(var i in tagss){
	  		tagaa_array[i] = [tagss[i],tagss_typeid[i]];
			 //console.log(i);
		 }  

	    //tagss.pop();
	    $.each(tagaa_array, function(){
	    	 $("#form-field-tags").before("<span data-typeid='"+this[1]+"' class='tag label label-info'>" + this[0] + "<span data-role='remove' class='tag_close'></span></span>"); //添加标签
	 });
	}
}
spite_key();
